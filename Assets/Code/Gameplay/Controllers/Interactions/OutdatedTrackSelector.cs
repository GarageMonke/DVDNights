...
namespace Rulebound
{
    public class OutdatedTrackSelectorController : MonoBehaviour, IOutdatedTrackSelectionController
    {
        [Header("References")] 
        ...
        private void InstallService()
        {
            ...
            ServiceLocator.RegisterService<IOutdatedTrackSelectionController>(this);
        }
    ...
    public interface IOutdatedTrackSelectionController
    {
        public Action OnTrackPlayRequested { get; set; }
        public Action OnTrackSelectionCloseRequested { get; set; }
        public Action OnTrackStopRequested { get; set; }
